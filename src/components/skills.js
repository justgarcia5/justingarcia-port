...
const Skills = () => (
  <div>
    ...
    <i className="fab fa-bootstrap" style={{color: "rgb(96, 44, 80)"}}/>
    ...
    <i className="fab fa-python" style={{color: "rgb(128, 128, 128)"}}></i>
    <i className="fab fa-php" style={{color: "green"}}></i>
  </div>
)
